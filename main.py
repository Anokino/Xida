...
if not os.path.isfile("config.py"):
    ...
    from config import release, cogs, botversion, des, pref, bbtoken, key, startup_extensions, logfile, err_mesg, err_mesg_pi, err_mesg_permission, dec, answers, default_rich_presence, mention, heightballp, hug_img, kiss_img
####################################Logs##############################################
...
bot = commands.Bot(description=des, command_prefix=pref, status=discord.Status.dnd, activity=discord.Game(
    name="💿Connexion à Discord.."))  # indiquez la description et le préfixe de votre bot (laissez les apostrophes)
...
async def on_ready():
    ...
    print("En cours d'éxécution sur:", platform.system(),
